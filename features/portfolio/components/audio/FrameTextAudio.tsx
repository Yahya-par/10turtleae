...
type FrameTextAudioProps = {
  scene: THREE.Object3D;
  nodes: Record<string, THREE.Object3D>;
};

export default function FrameTextAudio({
  scene,
  nodes,
}: FrameTextAudioProps) {
  ...
  useLayoutEffect(() => {
    ...
    const textObject = findSceneObject(
      scene,
      nodes,
      assetNames.text.frame,
      assetNames.text.frameBlender,
    );
