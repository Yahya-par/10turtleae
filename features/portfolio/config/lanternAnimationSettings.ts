...
export const lanternAnimationSettings = {
   ...
   */
  lanterns: [
    { u: 0.2, v: 0.55, h: 0.35, scale: 1.0, phase: 0, sway: 0.102, bob: 0.073 },
    { u: 0.38, v: 0.72, h: 0.58, scale: 1.08, phase: 1.4, sway: 0.095, bob: 0.064 },
    { u: 0.55, v: 0.48, h: 0.42, scale: 0.92, phase: 2.8, sway: 0.088, bob: 0.057 },
    { u: 0.72, v: 0.65, h: 0.78, scale: 1.04, phase: 4.1, sway: 0.108, bob: 0.069 },
    { u: 0.28, v: 0.82, h: 0.9, scale: 0.96, phase: 5.5, sway: 0.079, bob: 0.054 },
    { u: 0.48, v: 0.42, h: 0.22, scale: 1.12, phase: 0.9, sway: 0.101, bob: 0.072 },
    { u: 0.84, v: 0.58, h: 0.52, scale: 0.9, phase: 3.3, sway: 0.09, bob: 0.06 },
    { u: 0.62, v: 0.75, h: 0.68, scale: 1.0, phase: 6.2, sway: 0.097, bob: 0.066 },
  ],
} as const;
